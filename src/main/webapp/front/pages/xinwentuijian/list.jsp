        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">新闻推荐展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="xinwenbianhao" id="xinwenbianhao" placeholder="新闻编号" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('xinwentuijian','新增')" @click="jump('../xinwentuijian/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../xinwentuijian/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../xinwentuijian/detail.jsp?id='+item.id)"><span>{{item.xinwenbianhao}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../xinwentuijian/detail.jsp?id='+item.id)"><span>{{item.xinwenneirong}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../xinwentuijian/detail.jsp?id='+item.id)"><span>{{item.xinwenbiaoti}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../xinwentuijian/detail.jsp?id='+item.id)"><span>{{item.xingming}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#xinwenbianhao').val()) {
          param['xinwenbianhao'] = jquery('#xinwenbianhao').val() ? '%' + jquery('#xinwenbianhao').val() + '%' : '';
        }  
        if (jquery('#xinwenbiaoti').val()) {
          param['xinwenbiaoti'] = jquery('#xinwenbiaoti').val() ? '%' + jquery('#xinwenbiaoti').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('xinwentuijian/list', 'get', param, function(res) {
