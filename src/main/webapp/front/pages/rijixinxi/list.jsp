        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">日记信息展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              ...
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('rijixinxi','新增')" @click="jump('../rijixinxi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../rijixinxi/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../rijixinxi/detail.jsp?id='+item.id)"><span>{{item.rijibianhao}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../rijixinxi/detail.jsp?id='+item.id)"><span>{{item.rijibiaoti}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../rijixinxi/detail.jsp?id='+item.id)"><span>{{item.xingming}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        // 获取列表数据
        http.request('rijixinxi/list', 'get', param, function(res) {
