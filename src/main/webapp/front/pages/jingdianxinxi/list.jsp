        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">景点信息展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="jingdianbianhao" id="jingdianbianhao" placeholder="景点编号" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('jingdianxinxi','新增')" @click="jump('../jingdianxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../jingdianxinxi/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../jingdianxinxi/detail.jsp?id='+item.id)"><span>{{item.jingdianbianhao}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../jingdianxinxi/detail.jsp?id='+item.id)"><span>{{item.jingdianmingcheng}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../jingdianxinxi/detail.jsp?id='+item.id)"><span>{{item.jingdianneirong}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jingdianbianhao').val()) {
          param['jingdianbianhao'] = jquery('#jingdianbianhao').val() ? '%' + jquery('#jingdianbianhao').val() + '%' : '';
        }  
