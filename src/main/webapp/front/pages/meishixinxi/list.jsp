        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">美食信息展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">美食编号</label>
                <div class="layui-input-inline">
                  <input type="text" name="meishibianhao" id="meishibianhao" placeholder="美食编号" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('meishixinxi','新增')" @click="jump('../meishixinxi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../meishixinxi/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../meishixinxi/detail.jsp?id='+item.id)"><span>{{item.meishibianhao}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../meishixinxi/detail.jsp?id='+item.id)"><span>{{item.meishimingcheng}}</span></div>
                    <div class="ng-prslist-tit" @click="jump('../meishixinxi/detail.jsp?id='+item.id)"><span>{{item.xingming}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#meishibianhao').val()) {
          param['meishibianhao'] = jquery('#meishibianhao').val() ? '%' + jquery('#meishibianhao').val() + '%' : '';
        }  
        if (jquery('#meishimingcheng').val()) {
          param['meishimingcheng'] = jquery('#meishimingcheng').val() ? '%' + jquery('#meishimingcheng').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('meishixinxi/list', 'get', param, function(res) {
