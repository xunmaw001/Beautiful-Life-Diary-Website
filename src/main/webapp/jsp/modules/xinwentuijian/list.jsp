...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">新闻推荐管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>新闻推荐管理</span></li>
								<li class="breadcrumb-item active"><span>新闻推荐列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">新闻推荐列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										新闻编号
									</label>
									<input type="text" id="xinwenbianhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										新闻标题
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xinwenbianhao')">新闻编号<i id="xinwenbianhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#xinwenbianhaoSearch').val() != null && $('#xinwenbianhaoSearch').val() != ''){
				searchForm.xinwenbianhao ="%" +  $('#xinwenbianhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xinwentuijian/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				xinwenbianhao : searchForm.xinwenbianhao,	
		...
		function setDataRow(item,number){
			...
			var xinwenbianhaoCell  = document.createElement('td');

						 xinwenbianhaoCell.innerHTML = item.xinwenbianhao;


			row.appendChild(xinwenbianhaoCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("xinwentuijian/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("xinwentuijian/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xinwentuijian/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("xinwentuijian"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xinwentuijian");
