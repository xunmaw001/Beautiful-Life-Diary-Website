						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="xinwenbianhao" name="xinwenbianhao" class="form-control" v-model="ruleForm.xinwenbianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>新闻内容</label>

									<input id="xinwenneirong" name="xinwenneirong" class="form-control" v-model="ruleForm.xinwenneirong" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>新闻标题</label>
