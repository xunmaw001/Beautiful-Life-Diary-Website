...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>美食信息管理</span></li>
								<li class="breadcrumb-item active"><span>美食信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="meishibianhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										美食名称
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('meishibianhao')">美食编号<i id="meishibianhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#meishibianhaoSearch').val() != null && $('#meishibianhaoSearch').val() != ''){
				searchForm.meishibianhao ="%" +  $('#meishibianhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("meishixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				meishibianhao : searchForm.meishibianhao,	
		...
		function setDataRow(item,number){
			...
			var meishibianhaoCell  = document.createElement('td');

						 meishibianhaoCell.innerHTML = item.meishibianhao;


			row.appendChild(meishibianhaoCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("meishixinxi/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("meishixinxi/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("meishixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"meishixinxi");
