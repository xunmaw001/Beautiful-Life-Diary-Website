...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="jingdianbianhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										景点名称
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jingdianbianhao')">景点编号<i id="jingdianbianhaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jingdianmingcheng')">景点名称<i id="jingdianmingchengIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jingdianneirong')">景点内容<i id="jingdianneirongIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jingdianweizhi')">景点位置<i id="jingdianweizhiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#jingdianbianhaoSearch').val() != null && $('#jingdianbianhaoSearch').val() != ''){
				searchForm.jingdianbianhao ="%" +  $('#jingdianbianhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("jingdianxinxi/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				jingdianbianhao : searchForm.jingdianbianhao,	
		...
		function setDataRow(item,number){
			...
			var jingdianbianhaoCell  = document.createElement('td');

						 jingdianbianhaoCell.innerHTML = item.jingdianbianhao;


			row.appendChild(jingdianbianhaoCell);
			...
			var jingdianneirongCell  = document.createElement('td');

						 jingdianneirongCell.innerHTML = item.jingdianneirong;


			row.appendChild(jingdianneirongCell);
			var jingdianweizhiCell  = document.createElement('td');

						 jingdianweizhiCell.innerHTML = item.jingdianweizhi;


			row.appendChild(jingdianweizhiCell);
		...
		function sh(){
			...
			httpJson("jingdianxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
