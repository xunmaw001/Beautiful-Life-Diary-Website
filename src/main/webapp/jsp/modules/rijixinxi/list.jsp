		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">日记信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>日记信息管理</span></li>
								<li class="breadcrumb-item active"><span>日记信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">日记信息列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var rijineirongCell  = document.createElement('td');
						  ...
						  if(item.rijineirong != null && item.rijineirong != "" && item.rijineirong.length >= 11){
			  	rijineirongCell.innerHTML = item.rijineirong.substring(0, 10) + "..."; 
			  }else{
            ...
            crossBtn1.innerHTML = "转载"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"rijizhanshi\")");
			if(crossBtnControl('转载') == true){
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("rijixinxi/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("rijixinxi/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("rijixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"rijixinxi");
